...
export default function PrivacyPolicy() {
  return (
    <PageContainer>
      ...
      <ContentContainer>
        <TextContainer>
          <Title>Privacy Policy - Elixir Experiment</Title>
          <Text>Last updated: October 18, 2024</Text>
          <Text>
          ...
          <BoldText>Interpretation and Definitions</BoldText>
          ...
          <ul>
            ...
            <li>
              <Text>
                <strong>Application</strong> refers to Elixir Experiment, the
            ...
            <li>
              <Text>
                ...
                "We", "Us" or "Our" in this Agreement) refers to Elixir
                Experiment.
              </Text>
            </li>
            <li>
          ...
          <BoldText>Collecting and Using Your Personal Data</BoldText>
          ...
          <BoldText>Links to Other Websites</BoldText>
          <Text>
          ...
          <ul>
            <li>By email: jaidenhodson1013@gmail.com</li>
          </ul>
        </TextContainer>
      </ContentContainer>
